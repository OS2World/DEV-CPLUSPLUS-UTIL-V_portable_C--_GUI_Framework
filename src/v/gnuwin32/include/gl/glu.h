...
// see http://www.cygnus.com/ml/gnu-win32/1997-Dec/0023.html
/*
...
extern const GLubyte *  gluErrorString (GLenum error) APIENTRY;
extern void APIENTRY gluGetNurbsProperty (GLUnurbs* nurb, GLenum property, GLfloat* data);
extern const GLubyte *  gluGetString (GLenum name) APIENTRY;
...
extern GLUnurbs*  gluNewNurbsRenderer (void) APIENTRY;
extern GLUnurbs*  gluNewNurbsTessellatorEXT (void) APIENTRY;
extern GLUquadric*  gluNewQuadric (void) APIENTRY;
extern GLUtesselator*  gluNewTess (void) APIENTRY;
extern void  gluNextContour (GLUtesselator* tess, GLenum type) APIENTRY;
  // don't need that...
